...
// Package promodb wires every model generated for the promo_db database
...
//
//	if err := promodb.Default.EnsureSchemas(db); err != nil {
//		log.Fatal(err)
//	}
//	if err := promodb.Default.Migrate(db); err != nil {
//		log.Fatal(err)
//	}
...
// Default holds every model generated for the promo_db database. Attach it
...
//
//	promodb.Default.Register(&MyModel{})
...
//
//	if err := promodb.Default.Instrument(db); err != nil {
//		log.Fatal(err)
//	}
//
